...
## Лабораторная №2 "Простейшие методы шифрований текстовых сообщений"
...
Варианты заданий и теоретическая приведены в [методичке](https://github.com/itsecd/isb-2/blob/main/ISB_Lab2.pdf).
